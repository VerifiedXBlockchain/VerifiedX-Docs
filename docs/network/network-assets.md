...
|-------------|-------------------------------|---------
 Adriatic     | Light/Medium/Bold             | <a href={require('./assets/Adriatic.zip').default}>Download</a>
 Oswald       | Light/Regular/Medium/SemiBold | <a href={require('./assets/Oswald.zip').default}>Download</a>
