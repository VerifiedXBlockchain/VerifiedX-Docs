...
Access VerifiedX applications and wallet downloads.
...
Launch the browser-based wallet — no download required.

- [Open Web Wallet](https://wallet.verifiedx.io)
...
Sync your node quickly using the latest blockchain snapshot.

- [Download Snapshot](https://sync.verifiedx.io)

---

## Butterfly

Launch the Butterfly decentralized marketplace.

- [Open Butterfly](https://www.befree.io)
